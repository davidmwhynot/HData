// David Whynot 6.7.14 www.xdavesbanex.com
...
public class NewDeckFrame extends JFrame implements MouseListener {
	String user;
	JLabel userName = new JLabel("XXXXXXXXXXXXXXXXXXXX");
	JLabel headerText = new JLabel("New Deck");
	...
	public NewDeckFrame(String userToNewDeck) {
		super("HData");
		user = userToNewDeck;
